...
export default function DownloadRedirectPage() {
  return (
    <div className="flex flex-col items-center justify-center py-20 px-6 max-w-md mx-auto flex-grow w-full text-center">
      <h1 className="text-2xl font-bold mb-4">Downloads Panel</h1>
      <p className="text-sm text-slate-400 mb-6">Please upload an image and run reconstruction to download outputs.</p>
