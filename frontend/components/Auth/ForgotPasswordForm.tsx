...
export default function ForgotPasswordForm() {
  ...
  return (
    <div className="w-full max-w-md p-8 glass-card rounded-2xl shadow-xl">
      ...
      {message && (
        <div className="p-4 mb-6 text-sm text-emerald-600 dark:text-emerald-400 bg-emerald-100 dark:bg-emerald-950/40 border border-emerald-200 dark:border-emerald-900/50 rounded-lg">
          {message}
        </div>
      )}
